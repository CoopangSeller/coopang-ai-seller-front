...
import DetailPlanner from './components/DetailPlanner/DetailPlanner';
    ...
    <div className="min-h-screen flex flex-col font-sans">
      ...
      <header className="sticky top-0 z-[100] bg-white/80 backdrop-blur-xl border-b border-slate-200 px-6 py-4">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-xl font-black text-slate-900 leading-none">AI Sync Club</h1>
              <p className="text-[10px] font-bold text-blue-500 tracking-widest uppercase mt-1">Winning Logic Builder</p>
            </div>
          </div>
      ...
      <div className="bg-gradient-to-b from-blue-50 to-transparent pt-12 pb-6 px-6 text-center">
        <h2 className="text-3xl md:text-5xl font-black text-slate-900 mb-4 tracking-tight">
          {activeTab === 'detail' ? '팔리는 상세페이지, AI로 1분 만에.' : '시선을 끄는 썸네일, AI로 한 번에.'}
        </h2>
